...
async function sendBulkEmails() {
  try {
    console.log("Fetching subscribers from Redis...")
    ...
    // For safety, let's confirm before sending
    console.log("This will send emails to ALL subscribers. Press Ctrl+C to cancel.")
...
<body>
  ...
  <div class="footer">
    ...
    for (let i = 0; i < subscribers.length; i += batchSize) {
      ...
      console.log(`Processing batch ${i / batchSize + 1} of ${Math.ceil(subscribers.length / batchSize)}...`)

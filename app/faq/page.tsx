    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-200 via-purple-200 to-orange-200 text-gray-900 overflow-hidden relative">
      ...
      <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-extralight text-gray-700 mb-6">Frequently Asked Questions</h1>
          <p className="text-xl text-gray-600 mb-8">
            Get answers to common questions about Rallie and our AI-powered tennis training system
          </p>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-12 border border-gray-200 shadow-sm">
            ...
            <p className="text-gray-600 text-lg mb-8">
              We're compiling the most frequently asked questions from our community. In the meantime, feel free to

            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  ...
                  that eventually became a unicorn. I took that product from prototype to mass production, working with
                  amazing partners like Foxconn and Flex.
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">But Rallie is different. This one is personal.</p>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  I started alone in March 2025 — hacking together early prototypes, writing code, and 3D-printing parts
                  on my living room floor. Now, I'm joined by an incredible team of engineers who are just as obsessed
                  as I am about building something that actually thinks, adapts, and helps you improve.
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600">
                A world where every tennis player can reach their full potential with personalized, intelligent coaching
                that adapts to their unique style.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600">
                Innovation, accessibility, and player-first design drive everything we do. We believe technology should
                enhance, not replace, the joy of tennis.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Our integrated system combines AI-powered analysis with intelligent hardware to create a complete tennis
                training solution that thinks, learns, and adapts.
              </p>
            </div>
        ...
        <Card className="bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-200">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              We're building the future of tennis training, and we want you to be part of it. Join our waitlist and help
              shape Rallie.
            </p>
